...
export function ArchitectureGenerating({
  regenerate = false,
}: {
  regenerate?: boolean;
}) {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-fg">
            {regenerate ? dict.architecture.regeneratingTitle : dict.architecture.generatingTitle}
          </p>
          <p className="text-sm text-fg-muted">
            {dict.architecture.generatingBody}
          </p>
        </div>
      </div>
