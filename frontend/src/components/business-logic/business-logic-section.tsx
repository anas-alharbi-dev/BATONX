...
import type { SectionDescriptor, SectionKey } from "./business-logic-shared";
...
export function BusinessLogicSection({
  ...
  const label = dict.businessLogic.sections[section.key as keyof typeof dict.businessLogic.sections] ?? section.label;
