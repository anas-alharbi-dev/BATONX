...
import { SECTIONS, type SectionKey } from "./business-logic-shared";
import { BusinessLogicSection } from "./business-logic-section";
...
export function BusinessLogicSections({
  content,
  editable,
  editingKey,
  saving,
