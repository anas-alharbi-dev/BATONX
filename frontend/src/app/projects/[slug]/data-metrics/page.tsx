...
import { DataMetricsView } from "@/components/data/data-metrics-view";
...
export default function DataMetricsPage() {
    ...
    return (
      <>
        <EmptyState
          ...
          description="Metrics follow the brief, profiling and quality."
        >
          <Link
  ...
  return <DataMetricsView initialProject={project} />;
}
