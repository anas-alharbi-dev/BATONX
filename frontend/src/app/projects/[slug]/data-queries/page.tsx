...
import { DataQueriesView } from "@/components/data/data-queries-view";
...
export default function DataQueriesPage() {
    ...
    return (
      <>
        <EmptyState
          ...
          description="Queries follow the brief, profiling and quality."
        >
          <Link
  ...
  return <DataQueriesView initialProject={project} />;
}
