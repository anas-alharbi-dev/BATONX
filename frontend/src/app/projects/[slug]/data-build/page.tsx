...
import { DataTransformationView } from "@/components/data/data-transformation-view";
import { EmptyState, ErrorState } from "@/components/feedback/states";
import { buttonClasses } from "@/components/ui/button";
import { Skeleton } from "@/components/ui/skeleton";
import { api, ApiRequestError } from "@/lib/api/client";

export default function DataBuildPage() {
    ...
    return (
      <>
        <EmptyState
          ...
          description="The Transformation Plan follows the brief, profiling and quality."
        >
          <Link
  ...
  return <DataTransformationView initialProject={project} />;
}
